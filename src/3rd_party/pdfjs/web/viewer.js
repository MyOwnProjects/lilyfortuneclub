 ...
 (function () {
  ...
  (function (root, factory) {
   ...
   function configure(PDFJS) {
    PDFJS.imageResourcesPath = plug_url + 'web/images/';
    PDFJS.workerSrc = plug_url + 'build/pdf.worker.js';
    PDFJS.cMapUrl = plug_url + 'web/cmaps/';
   ...
   var PDFViewerApplication = {
    ...
    load: function pdfViewLoad(pdfDocument, scale, callback) {
     var self = this;
...
function getViewerConfiguration() {
 return {
  ...
  debuggerScriptPath: plug_url + 'web/debugger.js'
 };
}
