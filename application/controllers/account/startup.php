...
class Startup extends Account_base_controller {
	public function __construct(){
		...
		$steps = array(array(
			...
			'subject' => "Who we are?",
			'steps' => array(
				'<p>We are an independant team, based in San Francisco bay area, of <u>World Financial Group</u>. Our team lead (SMD), <b>Lily Min Zhu</b>, is top 25 of 70,000 agents in entire WFG, has made more than $350,000/year after two-year part time and one-year full time in this business. She had earned very good credibility from the customers, and recognitions from teammates and business partners. She is helping us to bulid success in personal career for everyone in this team.</p>
