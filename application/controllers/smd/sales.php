	...
	public function get_sales_list(){
		...
		if($total > 0){
			...
			foreach($ret['rows'] as $i => $r){
				...
				$ret['rows'][$i]['sales_provider'] = '<img style="height:30px" src="'.base_url().'src/img/'.$r['sales_provider'].'_logo.ico">';
				$dec = ' class="badge" style="border:1px solid #1a73eb !important;font-weight:normal !important;font-size:13px"';
