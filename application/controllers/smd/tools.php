...
echo '<html><head><meta charset="UTF-8"></head><body>';
	...
	private function create_plan_form_data($case_for, $plan_types, $plan_data,
		$case_age, $case_gender, $face_amount){
		
		//$case_for, $plan_descs, $plan_data
		//,$plan_code, $case_name, $case_age, $case_gender, $case_desc){
			$case_data = array(
				'name' => '',//$case_gender.$case_age.'NC'.$face_amount,
				'age' => $case_age, 
				'gender' => $case_gender, 
	...
	public function generate_plan($action = null){
		...
		if($this->input->server('REQUEST_METHOD') == 'POST'){
			...
			$face_amount = $this->input->post('face-amount');
			$plan_types = $this->input->post('plan-type');
			...
			$case_data = $this->create_plan_form_data($case_for, $plan_types, $plan_data,
				$case_age, $case_gender, $face_amount);
