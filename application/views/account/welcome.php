	...
	<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 block">
				<div class="panel panel-primary">
					...
					<div class="panel-body clearfix">
						<div class="block-icon"><img src="<?php echo base_url();?>src/img/give-money.svg"></div>
						<div class="block-text">
							<b>Do you want to startup your own business?</b><br/><br/>
							Start from here - building your business team.<br/><br/>
							<a class="btn btn-sm btn-success" href="<?php echo base_url();?>account/startup">Startup your business</a>
						</div>
					</div>
				</div>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 block">
				<div class="panel panel-primary">
					...
					<div class="panel-body clearfix">
						<div class="block-icon"><img src="<?php echo base_url();?>src/img/books-stack-of-three.svg"></div>
						<div class="block-text">
							<b>Do you understand your own family financial status?</b><br/><br/>
							Start to learn the finance knowledge.<br/><br/>
							<a class="btn btn-sm btn-success" href="<?php echo base_url();?>account/documents">Learn finance knowledge</a>
						</div>
					</div>
				</div>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 block">
				<div class="panel panel-primary">
					...
					<div class="panel-body clearfix">
						<div class="block-icon"><img src="<?php echo base_url();?>src/img/history-clock-button.svg?"></div>
						<div class="block-text">
							<b>Are you interested in WFG's history?</b><br/><br/>
							Watch the video to know about WFG's history.<br/><br/>
							<a class="btn btn-sm btn-success" href="javascript:void(0)">Watch WFG history</a>
						</div>
					</div>
				</div>
			</div>
