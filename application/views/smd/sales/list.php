...
<script>
	$('#sales-grid').data_table({
		header: [
			...
			{id: 'sales_policy_no', text: 'Policy #', sortable: true, width:'120px', align: 'left'}, 
			...
			{id: 'sales_policy', text: 'Provider / Type', width:'120px', align: 'left'}, 
			{id: 'sales_face_amount', text: 'DB', sortable: true, width:'40px', align:'center'},
		],
