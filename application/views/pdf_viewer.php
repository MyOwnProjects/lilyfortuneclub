 <html dir="ltr" mozdisallowselectionprint moznomarginboxes>
  <head>
   ...
   <link rel="stylesheet" href="<?php echo base_url();?>src/3rd_party/pdfjs/web/viewer.css">
<script src="<?php echo base_url();?>src/3rd_party/jquery-1.11.2.js"></script>
<script>var plug_url = '<?php echo base_url();?>src/3rd_party/pdfjs/'</script>
    <script src="<?php echo base_url();?>src/3rd_party/pdfjs/web/compatibility.js"></script>
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              ...
              <div id="toolbarViewerRight">
                ...
                <button id="download" class="toolbarButton-disabled toolbarButton download hiddenMediumView" title="Download" tabindex="34" data-l10n-id="download" disabled>
                  <span data-l10n-id="download_label">Download</span>
                </button>
