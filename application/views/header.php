	...
	<div id="main-header-menu" class="list-unstyled pull-right clearfix">
			...
			<div style="display:none">
					<div class="clearfix" style="border-bottom:1px solid #e5e5e5;">
						...
						<a class="menu-ico-url" href="<?php echo base_url();?>seminar" title="Seminar"><div class="menu-icon clearfix"><img src="<?php echo base_url();?>src/img/instructor-lecture-with-sceen-projection-tool.svg"><div class="text">Seminar</div></div></a>
