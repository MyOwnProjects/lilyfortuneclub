...
<div data-role="page" id="view-resource-0" class="view-resource" data-theme="d">
	...
	<div data-role="main" class="ui-content">
		...
		<div class="page-nav">
			<a class="nav-prev ui-btn-b" data-role="button" data-icon="arrow-l" href="resource#view-resource-1" data-transition="slide" data-iconpos="notext" data-inline="true" data-mini="true" data-direction="reverse">Prev</a>
			<a class="nav-next ui-btn-b" data-role="button" data-icon="arrow-r" href="resource#view-resource-1" data-transition="slide" data-iconpos="notext" data-inline="true" data-mini="true">Next</a>
		</div>
	</div>
</div>
<div data-role="page" id="view-resource-1" class="view-resource" data-theme="d">
	...
	<div data-role="main" class="ui-content">
		<div class="resource-content"></div>
		<div class="page-nav">
			<a class="nav-prev ui-btn-b" data-role="button" data-icon="arrow-l" href="resource#view-resource-0" data-transition="slide" data-iconpos="notext" data-inline="true" data-mini="true" data-direction="reverse">Prev</a>
			<a class="nav-next ui-btn-b" data-role="button" data-icon="arrow-r" href="resource#view-resource-0" data-transition="slide" data-iconpos="notext" data-inline="true" data-mini="true">Next</a>
		</div>
	</div>
</div>
<script>
