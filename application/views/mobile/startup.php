...
<div data-role="page" id="startup-<?php echo $i;?>" data-theme="d">
	...
	<div data-role="content">
		<div>
			...
			<div class="page-nav">
					<?php if($i > 0){?>
					<a class="nav-prev" data-role="button" data-icon="arrow-l" href="startup#startup-<?php echo $i - 1;?>" data-transition="slide" data-iconpos="left" data-inline="true" data-mini="true" data-direction="reverse">Prev</a>
					<?php
					}
					if($i < count($pages) - 1){
					?>
					<a class="nav-next" data-role="button" data-icon="arrow-r" href="startup#startup-<?php echo $i + 1;?>" data-transition="slide" data-iconpos="right" data-inline="true" data-mini="true">Next</a>
					<?php
					}
					?>
			</div>
